...
@section('content')
    <div class="header-nav">
        <a href="{{ route('home') }}">
            <img src="{{ asset('asset/app/images/icons/ArrowLeft.svg') }}" alt="arrow-left">
        </a>
                ...
                <div class="col-8 d-flex">
                    ...
                    @if ($report->reportStatuses->last()->status === 'in_process')
                        <div class="badge-pending ">
                            <img src="{{ asset('asset/app/images/icons/CircleNotch.svg') }}" alt="pending">
                            <p>Diproses</p>
                        </div>
                    @endif
                    ...
                    @if ($report->reportStatuses->last()->status === 'completed')
                        <div class="badge-success ">
                            <img src="{{ asset('asset/app/images/icons/Checks.svg') }}" alt="pending">
                            <p>Selesai</p>
                        </div>
                    @endif
